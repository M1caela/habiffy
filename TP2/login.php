...
<body class="bg-base-200" id="home">
    ...
    <div id="fondo-login" class=p-10>
        <main>
            <!-- LOGIN -->
            <div class="flex justify-center align-center 9-6 m-6">
                <fieldset class="fieldset bg-base-100 border-base-200 text-base-content rounded-box w-xs border p-10">
                    ...
                    <input type="email" class="input mb-4" placeholder="Email" />

                    <label class="font-semibold text-xl">Clave</label>
                    <input type="password" class="input mb-4" placeholder="Clave" />

                    <button class="btn btn-primary mt-4 font-semibold">Iniciar Sesión</button>
                    <a href="#.php" class="text-center mt-4 hover:scale-110 transition cursor-pointer">Registrarse</a>
                </fieldset>
            </div>

        
            <!-- CONTROLADOR DE TEMA -->
            <div class="join join-horizontal mt-10">
                <input
                    type="radio"
                    name="theme-buttons"
