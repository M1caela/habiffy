    ...
    <div id="contenedor" class="flex flex-col border-3 rounded-md p-2 m-10 shadow-md">
        <form action="" method="POST" class="flex flex-col gap-6 p-6 bg-base-300 rounded-xl">
            ...
            <fieldset class="form-control">
                ...
                <input type="text" name="habito" class="input input-bordered bg-base-300" required value="<?= htmlspecialchars($habito['habito']) ?>" />
            </fieldset>
            ...
            <fieldset class="form-control">
                ...
                <input type="text" name="icono" class="input input-bordered w-40 bg-base-300" placeholder="🧮" maxlength="2" required value="<?= htmlspecialchars($habito['icono']) ?>" />
                <label class="label text-sm text-info">Presiona <kbd class="kbd">Win</kbd> + <kbd class="kbd">.</kbd> para abrir el selector de emojis</label>
            </fieldset>
