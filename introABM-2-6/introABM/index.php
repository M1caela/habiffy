...
<head>
    ...
    <a href="ingresar.php">INGRESAR UN NUEVO REGISTRO</a> 
</head>
...
<body>
    ...
    <table class="table" border="1">
        ...
        ?>
           <tr>
                <td><?php echo $estafila['id'];?></td>
                <td><?php echo date('d/m/Y', strtotime($estafila['fec_nac']));?></td>
                <td><?php echo $estafila['nombre'];?></td>
                <td class="apellido"><?=$estafila['apellido']?></td>
                <td>
                    <a href="detalle.php?id=<?=$estafila['id']?>">[Ver detalle]</a>
                    [Editar]
                    [Borrar]
                </td>
            </tr>
